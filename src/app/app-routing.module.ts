...
const routes: Routes = [
  ...
  {
    path: 'reporte-grafico',
    //canActivate: [privateGuard],
    loadChildren: () => import('./reporte-grafico/reporte-grafico.module').then( m => m.ReporteGraficoPageModule)
  },
  {
    path: 'ver-grafico',
    //canActivate: [privateGuard],
    loadChildren: () => import('./ver-grafico/ver-grafico.module').then( m => m.VerGraficoPageModule)
  },
